# Generated by Django 2.2.1 on 2019-05-19 01:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(related_name='comments_owned', through='socials.Comment', to=settings.AUTH_USER_MODEL)),
                ('favorites', models.ManyToManyField(related_name='favorite_socials', through='socials.Fav', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='fav',
            name='social',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='socials.Social'),
        ),
        migrations.AddField(
            model_name='fav',
            name='user',
